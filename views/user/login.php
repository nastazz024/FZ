...
<div class="login-page">
    <div class="form">
        ...
        <form class="register-form" method="post" <?php echo $act != 'register' ? 'style="display: none;"' : '' ?>>
            ...
            <p class="message">Уже зарегистрированы? <a href="#">Вход</a></p>
            <input type="hidden" name="<?=Yii::$app->request->csrfParam?>"
                   value="<?=Yii::$app->request->csrfToken?>"/>
            <input type="hidden" name="act" value="register" />
        </form>

        <form class="login-form" method="post" <?php echo $act != 'login' ? 'style="display: none;"' : '' ?>>
