    ...
    <div class="product__content">
        <h6 class="product__title"><a href="/details/shuttle/'.$shuttle->id.'">'.$shuttle->name.'</a></h6>
    </div>
    ...
    <div class="product">
									<h2 class="product__title"><a href="/details/shuttle/'.$shuttle->id.'">'. $shuttle->name .'</a></h2>
